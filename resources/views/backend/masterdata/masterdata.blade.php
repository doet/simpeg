                ...
                <div class="col-sm-12">
                    <div class="tabbable">
                        <ul class="nav nav-tabs" id="myTab">
                            <li class="active">
                                <a data-toggle="tab" href="#home" onclick="load('mjabatan','#isi')">
                                    <i class="green ace-icon fa fa-home bigger-120"></i>
                                    Jabatan
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#messages" onclick="load('mdivisi','#isi')">
                                    Divisi
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#messages" onclick="load('mlibur','#isi')">
                                    Libur Nasional
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#messages" onclick="load('mdiagnosa','#isi')">
                                    Diagnosa Penyakit
                                </a>
                            </li>
